...
insert into TProduct values('P005', 'Bold: How to Go Big, Create Wealth and Impact the World', 'A radical, how-to guide for using exponential technologies, moonshot thinking, and crowd-powered tools', 18.9, 4.7);
insert into TProduct values('P005', 'Zero to One ', 'In Zero to One, legendary entrepreneur and investor Peter Thiel shows how we can find singular ways to create those new things.', 22.9, 4.6);   
insert into TProduct values('P005', 'How Google Works', 'Seasoned Google execs Eric Schmidt and Jonathan Rosenberg provide an insiders guide to Google', 09.9, 4.2);
insert into TProduct values('P005', 'Alibaba: The House That Jack Ma Built', 'An engrossing, insider’s account of how a teacher built one of the world’s most valuable companies', 20.9, 4.9);
insert into TProduct values('P005', 'Homo Deus', ' Describes a bleak future without sickness, hunger, and war', 10.99, 4.4);
